...
/**
 ...
 The delegate message passes the decoder seral number data from the <em>-(void)requestDecoderSerialNumber</em> method. This decoder serial number is for the decoder serial number on the device.
...
/**
 @brief This delegate method is called when data is returned from unsing the direct read isled part current update firmware data steps.

 This method when enable firmware, can called.

 @param (NSData*)data response when update firmware data proccess from iSled,received data and parser which type.
 */
...
/**
 @brief This method is used to request the serial number of decoder.

 This method is used to request the serial number of decoder from the engine frimware.The result of this method is returned with the <em>--(void)decoderSerialNumber:(NSString*)seralNumber;</em> delegate method.
...
/**
 @brief This method is used to erase all your setting and reset the engine to the orgianl factory defaults.

 This method is used to erase all your setting and reset the engine to the orgianl factory defaults.We should be careful to use this interface.
 */
...
/**
 force shut down when battery low.
 */
